...
import PythonEDARydnr.infrastructure.network.grpc.git_repo_found_pb2 as git_repo_found_pb2
import PythonEDARydnr.infrastructure.network.grpc.git_repo_found_pb2_grpc as git_repo_found_pb2_grpc
